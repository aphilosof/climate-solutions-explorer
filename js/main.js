...
function applyURLState(state) {
  ...
  try {
    ...
    const validVizTypes = ['circle', 'dendrogram', 'treemap', 'sunburst', 'network'];
...
function renderVisualization() {
  ...
  setTimeout(() => {
    try {
      ...
      ['_circlePackingCleanup', '_sunburstCleanup', '_treemapCleanup', '_dendrogramCleanup', '_forceNetworkCleanup'].forEach(key => {
